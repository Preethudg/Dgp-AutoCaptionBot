...
async def start_cmd(bot, message):
    ...
    await message.reply_photo(photo=Rkn_Bots.RKN_PIC,
        ...
        reply_markup=types.InlineKeyboardMarkup([[
            types.InlineKeyboardButton('Main Channel', url='https://t.me/kannadamovieskannadadubb'),
            types.InlineKeyboardButton('Help Group', url='https://t.me/kannadamovieskannadadubb')
            ],[
            types.InlineKeyboardButton('🔥 Source Code 🔥', url='https://t.me/kannadamovieskannadadubb')
    ]]))
